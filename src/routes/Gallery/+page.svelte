  ...
  <section class="my-10 justify-between">
    <div class="flex flex-col xl:flex-row gap-5">
      ...
      <div class="flex flex-col">
        <img src="./photo_2.png" alt="second picture" class="mb-[20px]"/>
        <img src="./photo_4.png" alt="fourth picture" class="mb-[20px]"/>
        <img src="./photo_5.png" alt="fifth picture" class="mb-[20px]"/>
      </div>
    </div>
    ...
    <div class="flex flex-col xl:flex-row gap-5">
      <div class="flex flex-col gap-1">
        ...
        <img src="./photo_12.png" alt="twelveth picture" class="mb-[20px]"/>
      </div>
      <div class="flex flex-col">
        <img src="./photo_9.png" alt="ninth picture" class="mb-[20px]"/>
        <img src="./photo_11.png" alt="eleventh picture" class="mb-[20px]"/>
        <img src="./photo_13.png" alt="thirteenth picture" class="mb-[20px]"/>
      </div>
    </div>
  </section>

  <a href="./Work" class="my-10 text-[#ffffff] font-semibold bg-[#321BDC] py-2 px-10 rounded-full">Back to work</a>
</div>
